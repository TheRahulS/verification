...
if(isset($_REQUEST['pwdrst']))
{
  ...
  if($res>0)
  {
    $message = '<div>
     ...
     <br>
     <p><button class="btn btn-primary"><a href="http://localhost/completecrud/passwordreset.php?secret='.base64_encode($email).'">Reset Password</a></button></p>
     <br>
...
$mail->Port = 587; 
$mail->Username   = 'rahulsoni7982@gmail.com';                     //SMTP username
$mail->Password   = 'zekurgjfdzuxqjws';    //Enter your password
...
if($mail->send())
{
  $msg = "We have  send e-mail  your password reset link!";
}
}
else
{
